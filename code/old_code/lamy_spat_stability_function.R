...
# edited May 10th 2018
{
  ...
  Ni<-aggregate(DWg.m~month+Habitat, FUN = "sum", data=fishweight)#community biomass in patch i at time t
  ...
  Nit<-pivot_wider(Ni, names_from= "month", values_from = "DWg.m")#change names to whatever time and biomass variables are called
  Nit[is.na(Nit)]=0
  Nit<-Nit[,2:7]#take coloms with biomass, leave out site and time info
